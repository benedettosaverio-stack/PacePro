...
export default function PacePro() {
  ...
  // Bottom nav
  const BottomNav = () => (
    <div className='bottom-nav' style={{position:'fixed',bottom:0,left:0,right:0,zIndex:100,background:'var(--bg-nav)',backdropFilter:'blur(20px)',borderTop:'1px solid var(--border-nav)',display:'flex',height:56,paddingBottom:'env(safe-area-inset-bottom,16px)'}}>
